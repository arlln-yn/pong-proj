...
public class GamePanel extends JPanel implements Runnable {
    ...
    public void checkCollision() {
        ...
        if (ball.x <= 0) {
            ...
            gameOver(); // added to end game once player2 reaches the winning score
        }
        if (ball.x >= GAME_WIDTH - BALL_DIAMETER) {
            ...
            gameOver(); // added to end game once player1 reaches the winning score
        }
    }
    ...
    // Added public gameOver to end game
